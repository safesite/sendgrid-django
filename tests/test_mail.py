...
class SendGridBackendTests(TestCase):
        ...
        with self.settings(SENDGRID_API_KEY="test_key"):
            ...
            self.assertEqual(
                mail,
                {
                    ...
                    "personalizations": [
                        {"to": [{"email": "andrii.soldatenko@test.com"}], "subject": ""}
                    ],
                    "mail_settings": {},
                    "from": {"email": "webmaster@localhost"},
                    "subject": "",
        ...
        with self.settings(SENDGRID_API_KEY="test_key"):
            ...
            self.assertEqual(
                mail,
                {
                    "content": [{"value": "", "type": "text/plain"}],
                    "personalizations": [
                        {"cc": [{"email": "andrii.soldatenko@test.com"}], "subject": ""}
                    ],
                    "mail_settings": {},
                    "from": {"email": "webmaster@localhost"},
                    "subject": "",
    ...
    def test_build_w_reply_to_sg_email(self):
        ...
        msg = EmailMessage(reply_to=("Andrii Soldatenko <andrii.soldatenko@test.com>",))
        with self.settings(SENDGRID_API_KEY="test_key"):
            mail = SendGridBackend()._build_sg_mail(msg)
            self.assertEqual(
                mail,
    ...
    def test_sandbox_true_no_whitelists_no_to(self):
        msg = EmailMessage(to=[])
        with self.settings(SENDGRID_API_KEY="test_key", SENDGRID_SANDBOX=True):
            mail = SendGridBackend()._build_sg_mail(msg)
            self.assertEqual(
                mail,
                {
        ...
        with self.settings(SENDGRID_API_KEY="test_key", SENDGRID_SANDBOX=True):
            ...
            self.assertEqual(
                mail,
                {
                    ...
                    "from": {"email": "webmaster@localhost"},
                    "personalizations": [
                        {"subject": "", "to": [{"email": "test@example.com"}]}
                    ],
                    "mail_settings": {"sandbox_mode": {"enable": True}},
                    "subject": "",
                },
        ...
        with self.settings(
            ...
            self.assertEqual(
                mail,
                {
                    ...
                    "from": {"email": "webmaster@localhost"},
                    "personalizations": [
                        {"subject": "", "to": [{"email": "test-test@example.com"}]}
                    ],
                    "mail_settings": {"sandbox_mode": {"enable": True}},
                    "subject": "",
                },
        ...
        with self.settings(
            ...
            self.assertEqual(
                mail,
                {
                    ...
                    "from": {"email": "webmaster@localhost"},
                    "personalizations": [
                        {"subject": "", "to": [{"email": "test@example.com.au"}]}
                    ],
                    "mail_settings": {"sandbox_mode": {"enable": True}},
                    "subject": "",
                },
        ...
        with self.settings(
            ...
            self.assertEqual(
                mail,
                {
                    ...
                    "from": {"email": "webmaster@localhost"},
                    "personalizations": [
                        {"subject": "", "to": [{"email": "test@example.net"}]}
                    ],
                    "mail_settings": {},
                    "subject": "",
                },
            ...
            self.assertEqual(
                mail,
                {
                    ...
                    "from": {"email": "webmaster@localhost"},
                    "personalizations": [
                        {"subject": "", "to": [{"email": "test@example.org"}]}
                    ],
                    "mail_settings": {"sandbox_mode": {"enable": True}},
                    "subject": "",
                },
